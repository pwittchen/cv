...
\begin{document}
  ...
  \end{tabular} \\ \\
    ...
    \subsection*{\normalsize{Professional experience}}
      ...
      \subsubsection*{\normalsize{Koyo, Senior Backend Engineer | Jan 2020 - now, London, UK (remote)}}
      Development and maintenance of the loan application for the fin-tech startup.\\
      \textbf{Tech Stack}: Kotlin, Spring Boot, Hibernate, PostgreSQL, JUnit, Google Cloud, Docker, Kubernetess, Open Banking, various integrations

      \subsubsection*{\normalsize{VCU, Owner | Jan 2020 - now, Gliwice, Poland}}
      Running the company of one focused on software development, consulting and research.
