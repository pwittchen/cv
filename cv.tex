...
\begin{document}
  ...
  \end{tabular} \\ \\
    ...
    \subsection*{\normalsize{Professional experience}}
      ...
      \textbf{Tech Stack}: Java, Flink, Kafka, RxJava, Android, Maven, Gradle, Python, ML technologies, Linux, Git and others

      \subsubsection*{\normalsize{Koyo, Senior Backend Engineer | Jan 2020 - Mar 2020, London, United Kingdom (remote)}}
      Development of the back-end application for the fin-tech startup offering loans in England.\\
