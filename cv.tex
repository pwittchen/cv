...
\begin{document}
  ...
  \end{tabular} \\ \\
    ...
    I am motivated software developer with more than 7 years of experience in creating mobile (Android), back-end and web applications in Java and more than 10 years of total programming experience. I am aware of the good software development practices, automated testing, design patterns, different programming paradigms and clean code principles. I continuously learn new things and improve my skills to deliver pragmatic, well-tested, high-quality solutions.

    \subsection*{\normalsize{Professional experience}}

      \subsubsection*{\normalsize{Koyo, Senior Backend Engineer (Consultant) | Jan 2020 - Mar 2020, London, UK / Remote}}
      Consulting and development of the back-end application for the fin-tech startup offering loans in UK.\\
      \textbf{Tech Stack}: Kotlin, Spring Boot, Gradle, Git, GitLab, Open Banking
