...
\begin{document}
  ...
  \end{tabular} \\ \\
    ...
    \subsection*{\normalsize{Professional experience}}
      ...
      \subsubsection*{\normalsize{VCU, Owner and Software Engineer | Nov 2019 - now, Gliwice, Poland / Remote}}
      Working as an independent contractor, software developer and consultant.\\
      \textbf{Tech Stack}: Java, Kotlin, Python, Bash, related libraries, frameworks and tools (depending on the project)
