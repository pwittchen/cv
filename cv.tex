...
\begin{document}
  ...
  \end{tabular} \\ \\
    ...
    \subsection*{\normalsize{Professional experience}}
      ...
      \textbf{Tech Stack}: Kotlin, Spring Boot, Gradle, Open Banking, Git, GitLab

      \subsubsection*{\normalsize{VCU, Owner | Nov 2019 - now, Gliwice, Poland}}
      Running the company of one and working as an independent contractor, software developer and consultant.
